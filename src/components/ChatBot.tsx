...
export const ChatBot: React.FC<ChatBotProps> = ({ isOpen, onClose }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      text: "Hello, I'm Annabel, the Eventum Orthopaedics chatbot. What would you like to know about Eventum, its people and products?",
      isUser: false
    }
  ]);
  ...
  return (
    <ChatBotContainer $isOpen={isOpen}>
      <ChatHeader>
        <HeaderLeft>
          <img src={ANNABEL_COLOUR_LOGO_URL} alt="Annabel Logo" style={{ width: 28, height: 28, marginRight: 8, borderRadius: '50%' }} />
      ...
      <ChatMessages>
        ...
        {isTyping && (
          <TypingIndicator>
            <img src={ANNABEL_MONO_LOGO_URL} alt="Annabel Mono Logo" style={{ width: 16, height: 16, marginRight: 6, verticalAlign: 'middle' }} />
            Annabel is typing...
          </TypingIndicator>
        )}
